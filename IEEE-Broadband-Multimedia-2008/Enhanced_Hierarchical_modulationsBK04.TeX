...
\end{figure}
\begin{figure} \center{
\includegraphics[width=2.60in, angle=0]{Voronoi_Enhanced.eps}
...
modulation, the Euclidean distance between the base-layer signals
and the enhancement-layer signals changes too and the distance of
some previous closest signal pairs may be not the shortest any
more. This may also happen when the enhancement layer is rotated.
