...
\end{array}.
\end{equation}
\noindent The extended OFDM symbol $\left\{\tilde{x}_{n}:\
-L_{cp}+1\leq m\leq L\right\}$ then passes through
digital-to-analog converter and pulse-shaping filter before
up-converted to the carrier frequency.
